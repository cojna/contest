...
solve :: Int -> Int
solve n = bfs01CSR 1 (buildGraph n) U.! 0 + 1

buildGraph :: Int -> SparseGraph Int
buildGraph n = buildSparseGraph n $ \builder -> do
    rep n $ \i -> do
        addDirectedEdge builder (i, rem (10 * i) n, 0)
        addDirectedEdge builder (i, rem (i + 1) n, 1)

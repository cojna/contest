...
solve a b
    = product
    . map (IntMod . succ . length)
    . L.group
    . L.sort
    $ concatMap primeFactors [b+1..a]
...
{-# INLINE (-%) #-}
(*%) :: Int -> Int -> Int
(I# x#) *% (I# y#) = case timesWord# (int2Word# x#) (int2Word# y#) of { z# -> case timesWord2# z# im# of { (# q#, _ #) -> case minusWord# z# (timesWord# q# MOD##) of { v# | isTrue# (geWord# v# MOD##) -> I# (word2Int# (plusWord# v# MOD##)) | otherwise -> I# (word2Int# v#)}}} where { im# = plusWord# (quotWord# 18446744073709551615## MOD##) 1##}
{-# INLINE (*%) #-}
(/%) :: Int -> Int -> Int

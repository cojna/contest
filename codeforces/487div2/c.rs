...
fn solve<R: std::io::Read, W: std::io::Write>(io: &mut IO<R, W>) {
    let mut res: Vec<Vec<char>> =
        vec!["AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA".chars().collect(),
             "ABABABABABABABABABABABABABABABABABABABABABABABABAB".chars().collect(),
             "ABABABABABABABABABABABABABABABABABABABABABABABABAB".chars().collect(),
             "ABABABABABABABABABABABABABABABABABABABABABABABABAB".chars().collect(),
             "ABABABABABABABABABABABABABABABABABABABABABABABABAB".chars().collect(),
             "ABABABABABABABABABABABABABABABABABABABABABABABABAB".chars().collect(),
             ...
             "ABABABABABABABABABABABABABABABABABABABABABABABABAB".chars().collect(),
             "ABABABABABABABABABABABABABABABABABABABABABABABABAB".chars().collect(),
             "BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB".chars().collect(),
             "CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC".chars().collect(),
             "CDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCD".chars().collect(),
             "CDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCD".chars().collect(),
             "CDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCD".chars().collect(),
             "CDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCD".chars().collect(),
             "CDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCD".chars().collect(),
             ...
             "CDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCD".chars().collect(),
             "CDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCD".chars().collect(),
             "DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD".chars().collect()];
    let (mut a, mut b, mut c, mut d): (usize, usize, usize, usize) = io.read();
    a -= 1;
    b -= 1;
    c -= 1;
    d -= 1;
